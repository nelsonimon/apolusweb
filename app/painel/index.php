                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center"><span class="text-top"></span><?php echo $total_usuarios; ?></div>
                                    <small>ativos</small>
                                </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                <div class="tiles-heading">Anúncios</div>
                                <div class="tiles-body-alt">
                                    <i class="fa  fa-tags"></i>
                                    <div class="text-center"><span class="text-top"></span><?php echo $total_anuncios; ?><span class="text-smallcaps"></span></div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                <div class="tiles-heading">Visualizados</div>
                                <div class="tiles-body-alt">
                                    <i class="fa  fa-eye"></i>
                                    <div class="text-center"><?php echo $total_visualizados; ?></div>
                                    <small>Anúncios Clicados</small>
                                </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                <div class="tiles-heading">Curtidas</div>
                                <div class="tiles-body-alt">
                                    <i class="fa fa-thumbs-up"></i>
                                    <div class="text-center"><?php echo $total_curtidas; ?></div>
                                    <small>Média de <?php echo $total_anuncios/$total_curtidas; ?> p/a</small>
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 clearfix">
                                    <h4 class="pull-left" style="margin: 0 0 20px;">Acessos <small>(diário)</small></h4>
                                    <div class="btn-group pull-right">
                                        <a href="javascript:;" class="btn btn-default btn-sm active">Mes</a>
                                    </div>
                                </div>
                                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="panel panel-grape">
                        <div class="panel-heading">
                              <h4><i class="icon-highlight fa fa-star"></i> Top 10 + clicados</h4>
                              <!-- <div class="options">
                        ...
                        <div class="panel-body">
                            <ul class="panel-tasks">
                                ...
                                //print_r($ofertas);
                                //echo $ofertas['titulo'];
                               for ($i=0; $i <count($ofertas['titulo']) ; $i++)
                                {
                                ?>
                                    <?php
                                        if($i<3)
                                    ...
                                    ?>
                                    <li class="item-<?php echo $list; ?>">
                                        <label>
                                            
                                            <span class="badge <?php echo $cor; ?> "><?php echo $ofertas['total'][$i]; ?></span>
                                            <span class="task-description"><?php echo $ofertas['titulo'][$i]; ?></span>
                                          
                                        </label>
                                        <div class="options todooptions">
                                            <span class="label label-default"><?php echo $ofertas['valor'][$i]; ?></span>
                                        </div>
                                    </li>
                                <?php
                                }
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-2">
                                    ...
                                    <h3 style="text-align: center; margin: 0; color: #808080;"><?php echo $total_visitas; ?></h3>
                                    <p style="text-align: center; margin: 0;">Visitas</p>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-2">
                                    ...
                                    <h3 style="text-align: center; margin: 0; color: #808080;"><?php echo $total_visitas_mes; ?></h3>
                                    <p style="text-align: center; margin: 0;">Visitas Mês</p>
                                    <hr class="hidden-md hidden-lg">
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-2">
                                    ...
                                    <h3 style="text-align: center; margin: 0; color: #808080;"><?php echo $total_visitas_unicas; ?> </h3>
                                    <p style="text-align: center; margin: 0;">Usuários</p>
                                    <hr class="hidden-md hidden-lg">
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-2">
                                    ...
                                    <h3 style="text-align: center; margin: 0; color: #808080;"><?php echo $total_visitas_mes_unicas; ?></h3>
                                    <p style="text-align: center; margin: 0;">Usuários Mês</p>
                                    <hr class="hidden-md hidden-lg">
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-2">
                                    ...
                                    <h3 style="text-align: center; margin: 0; color: #808080;"><?php echo $media_retorno; ?></h3>
                                    <p style="text-align: center; margin: 0;">Taxa Retorno</p>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-2">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="threads">
                                    <ul class="panel-threads">
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/aniss.png" alt="Aniss">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/corbett.png" alt="Corbett">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/dangerfield.png" alt="Dangerfield">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/doyle.png" alt="Doyle">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/jackson.png" alt="Jackson">
                                            <div class="content">
                                ...
                                <div class="tab-pane" id="comments">
                                    <ul class="panel-comments">
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/paton.png" alt="Corbett">
                                            <div class="content">
                                                <span class="actions"><div class="options"><div class="btn-group"><button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button><button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button></div></div></span>
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/watson.png" alt="Watson">
                                            <div class="content">
                                                <span class="actions"><div class="options"><div class="btn-group"><button class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button><button class="btn btn-default btn-xs"><i class="fa fa-times"></i></button></div></div></span>
                                ...
                                <div class="tab-pane" id="users">
                                    <ul class="panel-users">
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/paton.png" alt="Paton">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/tennant.png" alt="Tennant">
                                            <div class="content">
                                        ...
                                        <li>
                                            <img src="<?php echo $pathassets; ?>demo/avatar/jobs.png" alt="Jobs">
                                            <div class="content">
...
<script>
    $(function () {
        ...
        colors: ['#556b8d', '#e43725']
    });

    $('#site-statistics').highcharts({
         chart: {
            type: 'area'
        },
        title: {
        ...
        xAxis: {
            categories: [<?php echo $graf_acessos_dias;  ?>]
        },
        yAxis: {
            title: {
                text: 'Visitas'
        ...
        series: [{
            name: 'Visitas',
            data: [<?php echo $graf_acessos_total;  ?>]
    
        },{
            name: 'Unicos',
            data: [<?php echo $graf_acessos_unicos;  ?>]
